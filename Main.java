...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student("swathi", "A123", 3.8));

        students.add(new Student("rose", "B456", 3.5));

        students.add(new Student("seeni", "C789", 3.9));

        students.add(new Student("kavi", "D101", 3.2));

        students.add(new Student("suja", "E202", 4.0));
